...
Consider the file "pathaways_scoring.tsv", it contains a matrix with the enrichment score of 300 biological pathways into the "airway" dataset samples.
Renames the sample names using the identifiers used in "airway" dataset, create a summarized experiment and add to it all the  information about of the samples available in the right location.
...
Consider the file "airway_new.tsv" , map the ENSEMBL gene names to the corresponding gene symbols and put the information in the right location of the SummarizedExperiment. 
